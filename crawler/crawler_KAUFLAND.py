...
import scraper_KAUFLAND

SHOW_PRINTS = False

Crawler_Handler = crawler_handler.CrawlerHandler("Kaufland")
...
for product_to_find in Crawler_Handler.PRODUCTS_TO_CHECK:
     ...
     found_products = scraper_KAUFLAND.getting_articles_from_shop(product_to_find)
