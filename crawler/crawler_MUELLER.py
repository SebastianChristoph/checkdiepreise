...
import scraper_MUELLER
SHOW_PRINTS = False

Crawler_Handler = crawler_handler.CrawlerHandler("Mueller", "drogerie")
...
for product_to_find in Crawler_Handler.PRODUCTS_TO_CHECK:
     ...
     found_products = scraper_MUELLER.getting_articles_from_shop(product_to_find)
