...
import scraper.scraper_GLOBUS as scraper_GLOBUS

SHOW_PRINTS = False

Crawler_Handler = crawler_handler.CrawlerHandler("Globus", "baumarkt", with_id=True)
...
for product_to_find in Crawler_Handler.PRODUCTS_TO_CHECK:
     ...
     found_products = scraper_GLOBUS.getting_articles_from_shop(product_to_find)
